...
public class VerifyUser extends javax.swing.JFrame {
    ...
    public void getAllRecords(String email) {
        ...
        ArrayList<User> arraylist = UserDao.getAllRecords(email);
        Iterator<User> iterate = arraylist.iterator();
        while (iterate.hasNext()) {
            User user = iterate.next();
            if (!user.getEmail().equals("admin@gmail.com")) {
                dtm.addRow(new Object[]{user.getId(), user.getName(), user.getEmail(), user.getMobileNumber(), user.getAddress(), user.getSecurityQuestion(), user.getStatus()});
            }
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1319, 22, 30, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("Search");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(493, 84, -1, -1));
        ...
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(623, 81, 336, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 159, 1366, 470));

        jLabel3.setFont(new java.awt.Font("Arial", 3, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("*Click on row to update the Status");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(419, 671, -1, -1));
